...
import { conditionalIpRestrict } from "./middlewares/conditionalIp.middleware";
...
app.use(
  cors({
    origin: ["http://192.168.1.27:5173", "http://localhost:5173", "https://time-tracker-sparkle.vercel.app", "https://laughing-couscous-x54vr5jxq4x6c9g6r-5173.app.github.dev"],
